...
def detect(save_txt=False, save_img=False):
    ...
    #    weights = ''
    #    cfg    = ''
    #elif opt.model_type == 'inceptionv1':
    #    weights = ''
    #    cfg    = ''
    #elif opt.model_type == 'mobilenet':
    #    weights = ''
    #    cfg    = ''
    ...
    if ONNX_EXPORT:
        ...
        print('---1---')
        torch.onnx.export(model, img, model_name, verbose=True, opset_version=9)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model-type', type=str, default='yolov3', help='model type') 
